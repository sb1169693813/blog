...
@section('content')
    ...
    <div class="top_box">
        ...
        <div class="top_right">
            <ul>
                <li>管理员：{{session('user_info')->user_name}}</li>
        ...
        <ul>
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('admin/article')}}" target="main"><i class="fa fa-fw fa-image"></i>全部文章</a></li>
                </ul>
            </li>
            <li>
                <h3><i class="fa fa-fw fa-cog"></i>系统设置</h3>
                <ul class="sub_menu">
                    <li><a href="{{url('admin/link')}}" target="main"><i class="fa fa-fw fa-database"></i>友情链接</a></li>
                    <li><a href="" target="main"><i class="fa fa-fw fa-database"></i>自定义导航</a></li>
                </ul>
            </li>
            <li>
